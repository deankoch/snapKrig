...
Check out the [introduction vignette](https://cran.r-project.org/web/packages/snapKrig/vignettes/snapKrig_introduction.html) for a worked example with the Meuse soils data, or try the code below to get started right away. Some other code examples be found [here](https://github.com/deankoch/snapKrig/tree/master/examples).  We plan to publish a more detailed tutorial and benchmarking study in an [upcoming paper](https://github.com/deankoch/snapKrig/tree/master/rjarticle). 
