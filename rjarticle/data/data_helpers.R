...
#' ## Overview
#'
#' This set of helper functions generates the data reported in the paper. There are
#' three earth sciences datasets to load, as well as results from cross-validation (CV),
#' and compute-time benchmark experiments (see the "cv_experiment.R" and "bench_experiment.R"
#' files).
#'
#' For illustration we looked at three earth science datasets, related to atmosphere, soils, and
#' forest health. The first two are included in the `fields` and `sp` packages. The forest health
#' data can be downloaded from a permanent archive at FRDR using `rasterbc`.
#'
#'
