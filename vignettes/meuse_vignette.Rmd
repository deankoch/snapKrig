...
and they are lazy-loaded with the `sp` package.
...
simplified version of the one given in Cressie (2015) - addding half the variance before exponentiating. The plot
