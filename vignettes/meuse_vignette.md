...
All plots in this document except the first are generated by `bk_plot`,
...
These fitted kernels can be visualized using `bk_plot_pars`. This plots
...
vignettes we will look in more detail at how `bk_cmean` actually works,
